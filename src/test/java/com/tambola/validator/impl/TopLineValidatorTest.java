...
class TopLineValidatorTest {
    ...
    public void testTopLineClaimAccepted() {
        ...
        Assertions.assertEquals(ClaimStatus.ACCEPTED, tambolaManager.validateClaim(ClaimType.TOP_LINE, announcedNumbers));
    }
    ...
    public void testTopLineClaimRejectedDueToLateClaim() {
        ...
        Assertions.assertEquals(ClaimStatus.REJECTED, tambolaManager.validateClaim(ClaimType.TOP_LINE, announcedNumbers));
    }
